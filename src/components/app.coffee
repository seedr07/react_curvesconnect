  ...
  render: ->
    ...
    d.div {className: "navigation-container#{if showUpgrade then ' show-upgrade' else ''}"},
      ...
      d.div {className: 'header'}, d.div {className: 'outer'}, d.div {className: 'inner'},
        ...
        d.div {className: 'right-menu', onClick: @handleDropMenu},
          d.Glyph(glyph: 'user')
          d.span {}, [profile.username]
          d.Glyph(glyph: 'chevron-down')

        d.div {className: 'menu-browse'},
          d.Button {className: 'bro_search', onClick: @handleClick.bind(null, '/browse')},
            d.Glyph(glyph: 'search')
            d.span {}, $l('tooltips.browse')
          d.Button {className: 'bro_random', onClick: @handleClick.bind(null, '/discover')},
            d.Glyph(glyph: 'random')
            d.span {}, $l('tooltips.discover')
          d.Button {className: 'bro_inbox', onClick: @handleClick.bind(null, '/inbox')},
            d.Glyph(glyph: 'envelope')
            d.span {}, $l('tooltips.inbox')
          if @props.features.liked_by?.enabled
            d.Button {className: 'bro_admir', onClick: @handleClick.bind(null, '/liked_by')},
              d.Glyph(glyph: 'heart')
              d.span {}, $l('tooltips.likedBy')
          if @props.features.visitors?.enabled
            d.Button {className: 'bro_visit', onClick: @handleClick.bind(null, '/visitors')},
              d.Glyph(glyph: 'users')
              d.span {}, $l('tooltips.visitors')
          if @props.features.liked_by?.enabled
            d.Button {className: 'bro_like', onClick: @handleClick.bind(null, '/liked_by')},
              d.Glyph(glyph: 'star')
              d.span {}, $l('tooltips.likedBy')

      ...
      d.div {className: 'profile'}, [
        d.div {className: 'photos-and-info'}, [
          d.div {className: 'photos'}, [
            ...
            d.div {className: "action-container"},
              d.div {className: "action-like-container"},
                d.Button {className: "like-profile-container square#{if profile.flags?.liked then ' is-liked' else ''}", onClick: @handleLikeProfile},
                  d.Glyph(glyph: 'heart')
                  d.span {className: 'button-label'}, "Like"
              d.div {className: "action-message-container"},
                d.Button {className: "message-profile-container square", onClick: @handleSendMessage},
                  d.Glyph(glyph: 'envelope-o')

...
(function() {
  ...
  Header = createFactory({
    ...
    render: function() {
      var newDiscover, newLikedBy, newMessages, newVisitors, profile, ref1, ref2, ref3, ref4, ref5, ref6, ref7, showUpgrade;
      ...
      return d.div({
        ...
        glyph: 'sign-out'
      }), d.span({}, $l('tooltips.signout')))), d.DropingMenu({
        ref: 'drop'
      }, d.Button({
        onClick: this.handleClick.bind(null, '/myprofile')
      }, d.Glyph({
        ...
        glyph: 'user'
      }), d.span({}, [profile.username]), d.Glyph({
        glyph: 'chevron-down'
      })), d.div({
        className: 'menu-browse'
      }, d.Button({
        className: 'bro_search',
        onClick: this.handleClick.bind(null, '/browse')
      }, d.Glyph({
        glyph: 'search'
      }), d.span({}, $l('tooltips.browse'))), d.Button({
        className: 'bro_random',
        onClick: this.handleClick.bind(null, '/discover')
      }, d.Glyph({
        glyph: 'random'
      }), d.span({}, $l('tooltips.discover'))), d.Button({
        className: 'bro_inbox',
        onClick: this.handleClick.bind(null, '/inbox')
      }, d.Glyph({
        glyph: 'envelope'
      }), d.span({}, $l('tooltips.inbox'))), ((ref5 = this.props.features.liked_by) != null ? ref5.enabled : void 0) ? d.Button({
        className: 'bro_admir',
        onClick: this.handleClick.bind(null, '/liked_by')
      }, d.Glyph({
        glyph: 'heart'
      }), d.span({}, $l('tooltips.likedBy'))) : void 0, ((ref6 = this.props.features.visitors) != null ? ref6.enabled : void 0) ? d.Button({
        className: 'bro_visit',
        onClick: this.handleClick.bind(null, '/visitors')
      }, d.Glyph({
        glyph: 'users'
      }), d.span({}, $l('tooltips.visitors'))) : void 0, ((ref7 = this.props.features.liked_by) != null ? ref7.enabled : void 0) ? d.Button({
        className: 'bro_like',
        onClick: this.handleClick.bind(null, '/liked_by')
      }, d.Glyph({
        glyph: 'star'
      }), d.span({}, $l('tooltips.likedBy'))) : void 0)))));
    }
  });
...
},{"./browse":3,"./canvas":4,"./common":5,"./discover":7,"./history":8,"./locale":9,"./messaging":10,"./photos":11,"./profile":12,"./profile_list":13,"./settings":14,"./stores":15,"./support":16,"./upgrade":17,"events":undefined,"lodash":undefined,"react":undefined}],3:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
  var $l, BrowseFilter, ProfileSearchResults, React, SubFilter, _, createFactory, d, stores,
    slice = [].slice;
  ...
  SubFilter = createFactory({
    ...
    render: function() {
      var ages, distance, genders, i, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, results;
      genders = [
        {
          value: 'M',
          label: 'Men'
      ...
      return d.div({
        ...
        onClick: this.handleDropMenu
      }, d.span({}, (ref5 = this.props.filter) != null ? ref5.gender : void 0, " age ", (ref6 = this.props.filter) != null ? ref6.minAge : void 0, " ~ ", (ref7 = this.props.filter) != null ? ref7.maxAge : void 0), d.Glyph({
        glyph: 'chevron-down'
      })));
    }
  });
...
},{"./canvas":4,"./common":5,"./locale":9,"./stores":15,"lodash":undefined,"react":undefined}],4:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
...
},{"./common":5,"lodash":undefined,"react":undefined}],7:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
...
},{"./canvas":4,"./common":5,"./locale":9,"./profile_list":13,"./stores":15,"lodash":undefined,"moment":undefined,"react":undefined}],8:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
...
},{"events":undefined,"lodash":undefined}],9:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
  var _, _messages;
...
},{"./canvas":4,"./common":5,"./containers":6,"./locale":9,"./stores":15,"lodash":undefined,"moment":undefined,"react":undefined}],11:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
...
},{"./canvas":4,"./common":5,"./locale":9,"./profile":12,"./stores":15,"lodash":undefined,"react":undefined}],12:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
        ...
        d.div.apply(d, [{
          ...
          d.div.apply(d, [{
            className: 'photos'
              ...
              restClient: this.props.rootRestClient
            }, _.pick(_.defaults({}, this.state || {}, profile), 'age', 'gender', 'city', 'profileLocation'))], [d.div({
              className: "action-container"
            }, d.div({
              className: "action-like-container"
            }, d.Button({
              className: "like-profile-container square" + (((ref = profile.flags) != null ? ref.liked : void 0) ? ' is-liked' : ''),
              ...
              className: "action-message-container"
            }, d.Button({
              className: "message-profile-container square",
              onClick: this.handleSendMessage
            }, d.Glyph({
              glyph: 'envelope-o'
            }), d.span({
...
},{"./canvas":4,"./common":5,"./locale":9,"./stores":15,"lodash":undefined,"react":undefined}],13:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
  var $l, React, _, createFactory, d, moment, stores,
    slice = [].slice;
...
},{"./canvas":4,"./common":5,"./locale":9,"./stores":15,"lodash":undefined,"moment":undefined,"react":undefined}],14:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
  var $l, React, _, createFactory, d, moment, stores,
    indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
...
},{"./canvas":4,"./common":5,"./locale":9,"./stores":15,"lodash":undefined,"moment":undefined,"react":undefined}],15:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
...
},{"./common":5,"events":undefined,"lodash":undefined,"moment":undefined}],16:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
...
},{"./canvas":4,"./common":5,"./locale":9,"lodash":undefined,"react":undefined}],17:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
...
},{"./canvas":4,"./common":5,"./locale":9,"./stores":15,"lodash":undefined,"react":undefined}]},{},[1]);
